    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gradient-to-br from-gray-900 to-gray-800' : 'bg-gray-100'}`}>
      ...
      <div className="w-full px-2 py-4 pb-8">
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-xl p-4`}>
          ...
          <div className={`p-2 ${darkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'} rounded-xl border`}>
            <h3 className={`text-xl font-semibold ${darkMode ? 'text-white' : 'text-gray-900'} mb-4 px-2`}>AI Comparison Tool</h3>
            <form onSubmit={handleAiSubmit} className="mb-4 px-2">
              <div className="flex gap-3">
                <input
                  ...
                  placeholder="Ask a question to all three AIs..."
            ...
            {/* Perplexity Response - Full Width Below */}
            <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-300'} rounded-xl p-4 border mt-2`}>
              ...
              <div className={`ai-response ${darkMode ? 'text-gray-300' : 'text-gray-700'} text-sm min-h-[400px] max-h-[400px] overflow-y-auto`}>
            ...
            <div className={`mt-8 p-6 ${darkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'} rounded-xl border`}>
              ...
              {selectedHistoryItem && (
                <div className="pt-6 border-t border-gray-600">
                  ...
                  {/* Perplexity Saved Response - Full Width */}
                  <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-300'} rounded-xl p-6 border mt-6`}>
                    <h4 className={`text-lg font-semibold ${darkMode ? 'text-orange-400' : 'text-orange-600'} mb-3 flex items-center gap-2`}>
                      <span>🔍</span> Perplexity
                    </h4>
                    <div className={`ai-response ${darkMode ? 'text-gray-300' : 'text-gray-700'} text-sm min-h-[400px] max-h-[600px] overflow-y-auto`}>
      ...
      <footer className={`relative bottom-0 left-0 right-0 py-4 text-center text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'} mt-8`}>
        <div className="flex gap-4 justify-center mb-4">
          <button
            onClick={() => router.push('/horizontal-layout')}
            className={`px-6 py-2 ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-300 hover:bg-gray-400'} text-white rounded-lg font-medium transition-all`}
          >
            Switch to Horizontal Layout
          </button>
          <button
            onClick={() => router.push('/row-layout')}
            className={`px-6 py-2 ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-300 hover:bg-gray-400'} text-white rounded-lg font-medium transition-all`}
          >
            Switch to Row Layout
          </button>
          <button
            onClick={() => router.push('/grid-layout')}
            className={`px-6 py-2 ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-300 hover:bg-gray-400'} text-white rounded-lg font-medium transition-all`}
          >
            Switch to Grid Layout
          </button>
          <button
            onClick={() => router.push('/grid-only')}
            className={`px-6 py-2 ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-300 hover:bg-gray-400'} text-white rounded-lg font-medium transition-all`}
          >
            Switch to Grid Only
          </button>
