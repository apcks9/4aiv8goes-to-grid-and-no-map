        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 relative">
            ...
            <div className={`absolute left-1/4 flex items-center gap-6`}>
              <h1 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Grid Layout</h1>
      ...
      <div className="w-full px-2 py-4 pb-8">
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-xl p-4`}>
          ...
          <div className={`p-2 ${darkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'} rounded-xl border`}>
            <h3 className={`text-sm font-semibold ${darkMode ? 'text-white' : 'text-gray-900'} mb-1 px-2`}>AI Comparison Tool - Grid View</h3>
            <form onSubmit={handleAiSubmit} className="mb-1 px-2">
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 px-2 py-1 text-sm border ${darkMode ? 'bg-gray-600 border-gray-500 text-white placeholder-gray-400' : 'bg-white border-gray-300 text-gray-900'} rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all`}
                />
                <button
                  type="submit"
                  disabled={loading || !aiInput.trim()}
                  className="px-3 py-1 text-sm bg-blue-600 text-white rounded font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            {/* 2x2 Grid Layout */}
            <div className="grid grid-cols-2 grid-rows-2 gap-1 h-[calc(100vh-80px)]">
                ...
                <div className="pt-6 border-t border-gray-600">
                  ...
                  <div className="grid grid-cols-2 gap-4 h-[600px]">
                    ...
                    <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-300'} rounded-xl p-4 border`}>
                      <h4 className={`text-base font-semibold ${darkMode ? 'text-blue-400' : 'text-blue-600'} mb-2 flex items-center gap-2`}>
                        <span>🤖</span> Claude
                      </h4>
                      <div className={`ai-response ${darkMode ? 'text-gray-300' : 'text-gray-700'} text-xs h-[calc(100%-35px)] overflow-y-auto`}>
                    ...
                    <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-300'} rounded-xl p-4 border`}>
                      <h4 className={`text-base font-semibold ${darkMode ? 'text-green-400' : 'text-green-600'} mb-2 flex items-center gap-2`}>
                        <span>💬</span> ChatGPT
                      </h4>
                      <div className={`ai-response ${darkMode ? 'text-gray-300' : 'text-gray-700'} text-xs h-[calc(100%-35px)] overflow-y-auto`}>
                    ...
                    {/* Grok Saved Response */}
                    <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-300'} rounded-xl p-4 border`}>
                      <h4 className={`text-base font-semibold ${darkMode ? 'text-purple-400' : 'text-purple-600'} mb-2 flex items-center gap-2`}>
                        <span>⚡</span> Grok
                      </h4>
                      <div className={`ai-response ${darkMode ? 'text-gray-300' : 'text-gray-700'} text-xs h-[calc(100%-35px)] overflow-y-auto`}>
                    ...
                    <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-300'} rounded-xl p-4 border`}>
                      <h4 className={`text-base font-semibold ${darkMode ? 'text-orange-400' : 'text-orange-600'} mb-2 flex items-center gap-2`}>
